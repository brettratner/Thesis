		...
		<div class="container" style="margin-top: 65px">
			...
			<form method="post" action="signIn.php">
				...
				<div class="form-group">
					...
					<input name="UserName" type="text" value="<?php echo $_POST['UserName']; ?>" autocomplete="off" class="form-control"  placeholder="UserName"/>
				...
				<div class="form-group">
					...
					<input id="Password" name="Password" type="password" value="<?php echo $_POST['Password']; ?>" autocomplete="off" class="form-control" placeholder="Password" />
